    ...
    return [
      ...
      <div className="vh100 w100 article clear" key="body">
        ...
        <div className="rightDetail">
            ...
            {(() => {
              ...
              for (let i = 0, item; (item = data.article[i++]); ) {
                $dom.push(
                  <li>
                    {i}.
                    <a href="/detail/1/微信小程序wx.request request:fail ssl hand shake error.html">
          ...
          <ul class="link">
            <li>
              <a href="http://www.yodfz.com">写代码的熊猫</a>{" "}
            </li>{" "}
          </ul>
          <p class="title">扫码赞助</p>{" "}
          <p class="price">
            <img
        ...
        <div class="photoDetail">
          <a href="/photoDetail / 40. html ">
            <div
              ...
              style={{
                "background-image":
                  "url(http://www.yodfz.com/upload/20180505/1525510424000_thumb.png)"
              }}
            >
              {" "}
            </div>{" "}
        ...
        <div class="photoDetail">
          ...
          <a href="/photoDetail/35.html">
            <div
              ...
              style={{
                "background-image":
                  "url(http://www.yodfz.com/upload/20180501/1525146656000_thumb.png)"
              }}
            />
            <p>白马湖动漫展 - 黑SABER</p>
          </a>{" "}
        ...
        <div class="photoDetail">
          <a href="/photoDetail / 34. html ">
            <div
              ...
              style={{
                "background-image":
                  "url(http://www.yodfz.com/upload/20180501/1525146569000_thumb.png)"
              }}
            >
              {" "}
            </div>{" "}
        ...
        <div class="photoDetail">
          <a href="/photoDetail/33.html">
            <div
              ...
              style={{
                "background-image":
                  "url(http://www.yodfz.com/upload/20180501/1525146529000_thumb.png)"
              }}
            />
            <p>白马湖动漫展 - 兔子</p>
          </a>
